package ru.mirea.inbo02.pract9.inn;
...
public class Main {
    public static void main(String[] args) throws BadUserException {
        ...
        User user1 = new User("Andrey", "394829482951");
        inn.newUser(user1);
        User user2 = new User("Baga", "384928165014");
        inn.newUser(user2);
        User user3 = new User("Misha", "392948295928");
        inn.newUser(user3);
        User user4 = new User("Artem", "194829104829");
        inn.newUser(user4);
