package ru.mirea.inbo02.pract9.stud;
...
public class Main {
    public static void main(String[] args) throws EmptyNameException, StudentNotFoundException {
        ...
        lapClassUI.addStudent("Andrey", 5);
        lapClassUI.addStudent("Artem", 3);
        lapClassUI.addStudent("Oleg", 5);
        lapClassUI.addStudent("Nikita", 4);
        ...
        System.out.println();
        System.out.println(lapClassUI.searchName("Andrey"));
        lapClassUI.searchName("Misha");
    }
}